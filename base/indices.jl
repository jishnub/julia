...
getindex(S::Slice, i::Slice{A}) where {T<:Integer, A<:AbstractUnitRange{T}} = (@_inline_meta; @boundscheck checkbounds(S, i); i)
getindex(S::Slice, i::IdentityUnitRange{A}) where {T<:Integer, A<:AbstractUnitRange{T}} = (@_inline_meta; @boundscheck checkbounds(S, i); i)
...
# the following two methods are added to allow OffsetArrays to dispatch on the first argument without ambiguities
getindex(S::IdentityUnitRange, i::IdentityUnitRange{A}) where {T<:Integer, A<:AbstractUnitRange{T}} = (@_inline_meta; @boundscheck checkbounds(S, i); i)
getindex(S::IdentityUnitRange, i::Slice{A}) where {T<:Integer, A<:AbstractUnitRange{T}} = (@_inline_meta; @boundscheck checkbounds(S, i); i)
